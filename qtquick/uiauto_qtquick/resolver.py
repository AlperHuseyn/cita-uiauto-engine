# qtquick/uiauto_qtquick/resolver.py
...
class QtQuickResolver:
    ...
    QtQuick implementation using pywinauto UIA backend.
    """
    ...
    def resolve(self, element_name: str, overrides: Optional[Dict[str, Any]] = None) -> QtQuickElement:
