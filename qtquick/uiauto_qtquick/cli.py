...
def main(argv=None) -> int:
    ...
    p = argparse.ArgumentParser(prog="uiauto-qtquick", description="QtQuick/UIA automation runner.")
    ...
    runp.add_argument("--schema", default=None, help="Path to scenario schema JSON (uses core package schema by default)")
    ...
    if args.cmd == "run":
        ...
        # Create QtQuick-specific session, resolver, and actions
