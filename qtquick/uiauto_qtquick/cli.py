# qtquick/uiauto_qtquick/cli.py
"""CLI entry point for uiauto-qtquick."""
...
def main(argv=None) -> int:
    ...
    p = argparse.ArgumentParser(prog="uiauto-qtquick", description="QtQuick UI automation runner (pywinauto UIA).")
    ...
    runp.add_argument("--schema", default=None, help="Path to scenario schema JSON (optional, uses default if not provided)")
    ...
    if args.cmd == "run":
        ...
        # Create QtQuick-specific instances
